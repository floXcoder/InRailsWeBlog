(function (root, factory) {
    ...
    $.fn.autoComplete = function (options) {
        var configuration = $.extend({}, $.fn.autoComplete.defaults, options);
        ...
        return this.each(function () {
            ...
            function suggest(data) {
                ...
                if (data.length && val.length >= configuration.minChars) {
                    var s = '';
                    for (var i = 0; i < data.length; i++) s += configuration.renderItem(data[i], val);
                    that.sc.html(s);
                    that.updateSC(0);
                }
                else
                        ...
                        if (val != that.last_val) {
                            ...
                            if (configuration.cache) {
                                ...
                                if (!configuration.isFetchingIfPreviousIsNil) {
                                    for (var i = 1; i < val.length - configuration.minChars; i++) {

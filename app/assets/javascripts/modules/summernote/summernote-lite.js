...
// CONCATENATED MODULE: ./src/js/base/core/dom.js
                ...
                function wrap(node, wrapperName) {
                    ...
                    const wrapper = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()('<' + wrapperName + '>')[0]; // ### : Check parent presence
                ...
                function fromOffsetPath(ancestor, offsets) {
                    let current = ancestor; // ### : Check if childNodes exists
...
// CONCATENATED MODULE: ./src/js/base/core/async.js
                ...
                function createPicture(url, param, imageId, srcsets) {
                    return external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.Deferred(function (deferred) {
                        const $picture = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()('<picture>');
                        ...
                        const $img = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()('<img>').addClass('lazyload').attr('data-src', url).attr('data-id', imageId);
                        $picture.append($img);
                    ...
                    insertParagraph(editable, rng) {
                        ...
                        if (splitRoot) {
                            ...
                            if (dom.isLi(splitRoot) && (dom.isEmpty(splitRoot) || dom.deepestChildIsEmpty(splitRoot))) {
                                ...
                                let blockquote = null; // ### Break blockquote or code block
...
// CONCATENATED MODULE: ./src/js/base/module/Toolbar.js
                ...
                class Toolbar_Toolbar {
                    ...
                    followScroll() {
                        ...
                        const statusbarHeight = this.$statusbar.height(); // ### : Ensure otherBarHeight is defined
...
// CONCATENATED MODULE: ./src/js/lite/ui.js
                ...
                const popover = renderer["a" /* default */].create(['<div class="note-popover bottom">', '<div class="note-popover-arrow"/>', '<div class="note-popover-content note-children-container"/>', '</div>'].join(''), function ($node, options) {

...
export default class DropZone extends Reflux.Component {
    static propTypes = {
        ...
        dataModel: React.PropTypes.string.isRequired,
        dataModelId: React.PropTypes.number,
        uploadUrl: React.PropTypes.string,
        className: React.PropTypes.string,
        dataName: React.PropTypes.string,
        method: React.PropTypes.string,
        isMultipleFilesUploaded: React.PropTypes.bool,
        isAutoUploaded: React.PropTypes.bool,
        hasRemoveLinks: React.PropTypes.bool,
        hasLegendField: React.PropTypes.bool,
        hasCopyrightField: React.PropTypes.bool,
        acceptedFiles: React.PropTypes.string,
        maxFiles: React.PropTypes.number,
        maxFileSize: React.PropTypes.number,
        dropZoneMessage: React.PropTypes.string,
        imageInputPlaceholder: React.PropTypes.string,
        children: React.PropTypes.object,
        onFileAdded: React.PropTypes.func,
        onUploadError: React.PropTypes.func,
        onUploadSuccess: React.PropTypes.func,
        onUploadRemove: React.PropTypes.func,
        defaultData: React.PropTypes.object,
        serverFiles: React.PropTypes.array,

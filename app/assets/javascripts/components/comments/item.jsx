...
export default class CommentItem extends React.Component {
    ...
    _handleDeleteClick = (event) => {
        ...
        Notification.alert(I18n.t('js.comment.delete.confirmation_message'), 6000, I18n.t('js.comment.delete.confirmation_button'), this.props.onDelete.bind(this, this.props.comment.id));
    };

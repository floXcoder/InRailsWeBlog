...
module Topics
  class StoreService < BaseService
    ...
    def sanitize_html(html, lazy_image = true)
      ...
      html = sanitize(html, tags: %w[h1 h2 h3 h4 h5 h6 blockquote p a ul ol nl li b i strong em strike code hr br table thead caption tbody tr th td pre img], attributes: %w[style class href name target src alt center align data-topic-relation-id])

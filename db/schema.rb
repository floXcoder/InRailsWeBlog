...
ActiveRecord::Schema.define(version: 20170225200735) do
  ...
  create_table "article_relationships", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id", "parent_id", "child_id"], name: "index_article_relationship_uniqueness", unique: true, using: :btree
    t.index ["user_id"], name: "index_article_relationships_on_user_id", using: :btree
  end
  ...
  create_table "articles", force: :cascade do |t|
    ...
    t.index ["slug"], name: "index_articles_on_slug", unique: true, where: "(deleted_at IS NULL)", using: :btree
    t.index ["topic_id", "visibility"], name: "index_articles_on_topic_id_and_visibility", where: "(deleted_at IS NULL)", using: :btree
    t.index ["user_id", "visibility"], name: "index_articles_on_user_id_and_visibility", where: "(deleted_at IS NULL)", using: :btree
  end
  ...
  create_table "bookmarks", force: :cascade do |t|
    ...
    t.datetime "created_at",                      null: false
    t.datetime "updated_at",                      null: false
    t.index ["bookmarked_id", "bookmarked_type"], name: "index_bookmarks_on_bookmarked_id_and_bookmarked_type", using: :btree
    t.index ["user_id", "bookmarked_id", "bookmarked_type"], name: "index_user_and_bookmarks_uniqueness", unique: true, using: :btree
  ...
  create_table "outdated_articles", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["article_id", "user_id"], name: "index_outdated_articles_on_article_id_and_user_id", unique: true, using: :btree
    t.index ["article_id"], name: "index_outdated_articles_on_article_id", using: :btree
    t.index ["user_id"], name: "index_outdated_articles_on_user_id", using: :btree
  end
  ...
  create_table "tags", force: :cascade do |t|
    ...
    t.index ["slug"], name: "index_tags_on_slug", unique: true, where: "(deleted_at IS NULL)", using: :btree
    t.index ["user_id", "visibility"], name: "index_tags_on_user_id_and_visibility", where: "(deleted_at IS NULL)", using: :btree
  end
  ...
  create_table "topics", force: :cascade do |t|
    ...
    t.index ["name", "user_id"], name: "index_topics_on_name_and_user_id", unique: true, using: :btree
    t.index ["slug"], name: "index_topics_on_slug", unique: true, where: "(deleted_at IS NULL)", using: :btree
    t.index ["user_id"], name: "index_topics_on_user_id", where: "(deleted_at IS NULL)", using: :btree
  end
  ...
  create_table "trackers", force: :cascade do |t|
    ...
    t.datetime "created_at",                     null: false
    t.datetime "updated_at",                     null: false
    t.index ["tracked_id", "tracked_type"], name: "index_trackers_on_tracked_id_and_tracked_type", using: :btree
  end
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.index ["pseudo"], name: "index_users_on_pseudo", where: "(deleted_at IS NULL)", using: :btree
    t.index ["reset_password_token"], name: "index_users_on_reset_password_token", unique: true, using: :btree
    t.index ["slug"], name: "index_users_on_slug", unique: true, where: "(deleted_at IS NULL)", using: :btree

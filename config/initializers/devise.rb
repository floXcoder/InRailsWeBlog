...
Devise.setup do |config|
  ...
  config.mailer_sender = ENV['WEBSITE_EMAIL']
  ...
  config.remember_for = ActiveSupport::Duration.build(InRailsWeBlog.settings.session_duration)
  ...
  config.password_length = InRailsWeBlog.settings.user_password_min_length..InRailsWeBlog.settings.user_password_max_length

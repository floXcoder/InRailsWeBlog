...
set :linked_dirs, %w[db/dump lib/geocoding log node_modules public/assets public/sitemaps public/seo_cache public/uploads public/system tmp/pids tmp/cache tmp/sockets vendor/bundle]

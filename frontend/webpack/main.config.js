...
const mainConfig = {
    ...
    module: {
        ...
        // Only files pull by js or css resources are processed here
        // File are copied by copy webpack
        rules: [
            {
                test: /\.(js|jsx)$/i,
...
Object.entries(config.alias)
    .forEach(([key, value]) => {
        mainConfig.resolve.alias[key] = path.resolve(value);
    });
...
Object.entries(config.plugins)
    .forEach(([key, value]) => {
        ...
        if (pluginName.includes('.js') || pluginName.includes('.cjs') || pluginName.includes('.jsx')) {
